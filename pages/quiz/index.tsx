  ...
  return session.status == 'loading' ? (
    ...
    <div className="overflow-x-hidden relative flex bg-orange-50 flex-col justify-center items-center w-screen h-screen">
      <a
        ...
        className={`text-left tracking-wider hover:border-1 hover:border-green-500 hover:ring-2 hover:ring-offset-4 rounded-lg cursor-pointer px-20 p-1 text-gray-800 hover:text-black font-bold text-lg hover:bg-green-500 opacity-70`}>
        <span>20 Quiz Challenge</span>
      </a>
    </div>
  );
};
