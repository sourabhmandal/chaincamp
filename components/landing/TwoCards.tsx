...
function TwoCards() {
  return (
    <div className="bg-[#131927] flex flex-col text-slate-200 grid-cols-2 gap-4 p-4 sm:p-8 md:p-16 lg:p-32 mx-auto md:grid">
      <div className="flex flex-col items-center justify-start">
        <h3 className="text-2xl font-extrabold leading-8 tracking-tight text-center text-slate-50 sm:text-3xl sm:leading-10">
          Standalone page
        </h3>
